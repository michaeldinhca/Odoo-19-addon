...

{
	...
	""",
	"author": "BROWSEINFO",
	"website" :'https://www.browseinfo.com/demo-request?app=bi_pos_warranty&version=18&edition=Community',
	"price": 99,
	"currency": 'EUR',
	...
	"data": [
		...
		'views/extended_warranty_claim.xml',
	],
	'qweb': [
	],
	'assets': {
		'point_of_sale._assets_pos': [
			...
			'bi_pos_warranty/static/src/js/Screens/EditListPopup.js',
			'bi_pos_warranty/static/src/js/Screens/pos_store.js',
			'bi_pos_warranty/static/src/xml/pos.xml',
		],
	},
	"auto_install": False,
	"installable": True,
	"live_test_url":'https://www.browseinfo.com/demo-request?app=bi_pos_warranty&version=18&edition=Community',
